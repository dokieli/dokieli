...
**Internationalization**: Dokieli suports internationalization and localization in order to make the user interface accessible in different languages. We welcome contributions to improve existing translations or add new languages. You can contribute translations via [Weblate](https://hosted.weblate.org/projects/dokieli/), or submit changes directly through [Github](https://git.dokie.li/).
