    ...
    <aside aria-labelledby="${id}-label" class="do on" dir="${Config.User.UI.LanguageDir}" id="${id}" lang="${Config.User.UI.Language}" rel="schema:hasPart" resource="#${id}" xml:lang="${Config.User.UI.Language}">
      ...
      <form>
        <fieldset id="${id}-fieldset">
          ...
          <ul>
            <li><input type="radio" id="create-new-document-article" name="create-new-document" value="create-new-document-article" checked="checked" /> <label for="create-new-document-article"> <label for="create-new-document-cv">${Icon['.fas.fa-newspaper']} <span class="create-new-document-article"><strong data-i18n="create-new-document-article.strong">Article</strong> <span data-i18n="create-new-document-article.span">Write your story, scholarly article, report a story, blog.</span></span</label></li>
