...
export function initButtons() {
  ...
  Config.Button = {
    ...
    Info: {
      ...
      Keys: getButtonHTML({ key: "info.keys.button", button: "info", buttonClass: "info", buttonRel: "rel:help", buttonResource: `${docsBaseURL}#feature-keys` }),
      ...
      NewDocument: getButtonHTML({ key: "info.new-document.button", button: "info", buttonClass: "info", buttonRel: "rel:help", buttonResource: `${docsBaseURL}#feature-new-document` }),
